  ...
  return (
    ...
    >
      ...
      >
        ...
        <TextField onChange={(event) => setNameLoginCustomer(event.target.value)} value={nameLoginCustomer} style={{ margin: "5px", marginTop: "10px", width: "500px" }} id="outlined-basic" label="Tên đăng nhập" variant="outlined" />
        <TextField onChange={(event) => setNameCustomer(event.target.value)} value={nameCustomer} style={{ margin: "5px", marginTop: "10px", width: "500px" }} id="outlined-basic" label="Tên người dùng" variant="outlined" />
        <TextField onChange={(event) => setNumberPhoneCustomer(event.target.value)} value={numberPhoneCustomer} style={{ margin: "5px", width: "500px" }} type="number" id="outlined-basic" label="Số điện thoại" variant="outlined" />
        <TextField onChange={(event) => setAddressCustomer(event.target.value)} value={addressCustomer} style={{ margin: "5px", width: "500px" }} id="outlined-basic" label="Địa chỉ" variant="outlined" />
        <TextField onChange={(event) => setPasswordCustomer(event.target.value)} value={passwordCustomer} style={{ margin: "5px", width: "500px" }} type="password" id="outlined-basic" label="Mật khẩu" variant="outlined" />
        <TextField onChange={(event) => setAcceptPasswordCustomer(event.target.value)} value={acceptPasswordCustomer} style={{ margin: "5px", width: "500px" }} type="password" id="outlined-basic" label="Nhập lại mật khẩu" variant="outlined" />
        <Button onClick={addCustomer} style={{ margin: "auto", marginBottom: "5px" }} variant="contained">Thêm nhân viên mới</Button>
      </Dialog>
